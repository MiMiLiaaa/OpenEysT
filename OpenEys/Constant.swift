...
let TINY_FONT = UIFont.systemFont(ofSize: TINY_FONT_SIZE)
let SMALL_FONT = UIFont.systemFont(ofSize: SMALL_FONT_SIZE)
let LABEL_FONT = UIFont.systemFont(ofSize: LABEL_FONT_SIZE)
let SYSTEM_FONT = UIFont.systemFont(ofSize: SYSTEM_FONT_SIZE)
let BUTTON_FONT = UIFont.systemFont(ofSize: BUTTON_FONT_SIZE)
